...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('support', url='https://t.me/movies_hub_group_2022'),
                InlineKeyboardButton('channel', url='https://t.me/mc_movie_update_2022')
            ],
            [
                InlineKeyboardButton('Movies', url=f'https://t.me/movies_hub_group_2022')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('movie club', url='https://t.me/movies_hub_group_2022')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our Channel ⭕️",url="https://t.me/mc_movie_update_2022")]
        )
    else:
        btn.append(
